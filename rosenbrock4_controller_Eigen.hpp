...
#ifndef BOOST_NUMERIC_ODEINT_STEPPER_ROSENBROCK4_CONTROLLER__EIGEN_HPP_INCLUDED
#define BOOST_NUMERIC_ODEINT_STEPPER_ROSENBROCK4_CONTROLLER__EIGEN_HPP_INCLUDED
...
class rosenbrock4_Eigen_controller
{
private:
...
public:
    ...
    typedef rosenbrock4_Eigen_controller< Stepper > controller_type;


    rosenbrock4_Eigen_controller( value_type atol = 1.0e-6 , value_type rtol = 1.0e-6 ,
    ...
    rosenbrock4_Eigen_controller( value_type atol, value_type rtol, time_type max_dt,
                            const stepper_type &stepper = stepper_type() )
...
#endif // BOOST_NUMERIC_ODEINT_STEPPER_ROSENBROCK4_CONTROLLER__EIGEN_HPP_INCLUDED
